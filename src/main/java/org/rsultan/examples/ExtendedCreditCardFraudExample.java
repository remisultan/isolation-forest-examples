...
public class ExtendedCreditCardFraudExample {

  // Dataset present in https://www.kaggle.com/mlg-ulb/creditcardfraud
  ...
  public static void main(String[] args) throws IOException, ClassNotFoundException {
    ...
    if (!file.exists()) {
      int nbTrees = 200;
      IsolationForest model = new ExtendedIsolationForest(nbTrees, 2).setSampleSize(256)
